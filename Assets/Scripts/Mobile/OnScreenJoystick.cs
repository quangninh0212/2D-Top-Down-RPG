...
// Floating movement stick. The whole touch zone accepts input: wherever the
// thumb lands, the stick re-centres itself there, so the player always has room
// to drag in every direction - even if part of the zone sits under a system bar
// or off-screen.
public class OnScreenJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    public void Init(RectTransform zoneRect, RectTransform backgroundRect, RectTransform handleRect, float range)
    {
        touchZone = zoneRect;
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        MobileInput.MoveInput = Vector2.zero;
    }
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        MobileInput.MoveInput = inputVector.magnitude < deadZone ? Vector2.zero : inputVector;
    }
